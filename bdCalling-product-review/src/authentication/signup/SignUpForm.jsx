...
const SignUpForm = () => {
  ...
  return (
    <div>
      <div className=" mt-2 lg:w-3/4 bg-black  bg-opacity-30  mx-auto border  rounded shadow-lg shadow-gray-300 p-5 text-black">
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <p className="mt-2">
            ...
            <Link to="/login">
              <span className="text-blue-700 text-lg font-medium">Login</span>
            </Link>
          </p>
